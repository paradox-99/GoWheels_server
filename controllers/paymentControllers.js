...
const bookingInfo = async (req, res, io) => {
    try {
        console.log(io)
        // await sendEmail('absbashar04@gmail.com', 'John Doe', 'car123', 'Tesla Model S', '2024-10-20');
        io.emit('payment-success', { message: 'Your payment was successful!' });
        const responseMessage = { message: 'Booking completed and email sent.' };
...
module.exports = { paymentFail, bookingInfo }
